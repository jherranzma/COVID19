...
```{r}
CCAA_camas_UCI=read_csv("Datadista/COVID 19/ccaa_camas_uci_2017.csv")
```
...
```{r}
poblacion_CCAA_long=read_tsv("covid19-master/data/DataINE_España/Poblacion_CCAA_2017_2019_2853.csv")
...
#pivot_wider para pasar a modelo ancho
...
```{r}
ccaa_altas_long=read_csv("covid19-master/data/COVID_19_Datadista/COVID19/ccaa_covid19_altas_long.csv")
...
```{r}
ccaa_casos_wider=read_csv("covid19-master/data/COVID_19_Datadista/COVID19/ccaa_covid19_casos.csv")
